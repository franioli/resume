...
\colorbox{bgcol}{
	\parbox{0.45\linewidth}{
		...
		\begin{center}
    		...
    		\textcolor{white}{
            I am a PhD student in Geoinformatics dealing with photogrammetry and 3D reconstruction in challenging situations, such as alpine glacier monitoring. 
            I'm working on Deep Learning image matching. 
            I like coding and strongly believe in open-source software, data, and science.
            I have a topographic background and I am a UAV pilot.}
		\end{center}
	}
}
\vspace{20pt}
...
\cvlist{\underline{Ioli{,} F.}{,} Dematteis{,} N.{,} Giordan{,} D.{,} Nex{,} F. et al.{,} 2024. Deep Learning Low-cost Photogrammetry for 4D Short-term Glacier Dynamics Monitoring. \textit{PFG – Journal of Photogrammetry, Remote Sensing and Geoinformation Science}. \href{https://doi.org/10.1007/s41064-023-00272-w}{[Paper]} \href{https://github.com/franioli/icepy4d}{[Code]}}
