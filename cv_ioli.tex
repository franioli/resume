...
%
\cvevent{2020}{Internship}{Politecnico di Milano, \href{https://labmgf.dica.polimi.it/}{DICA}}{Conducted fielworks for surveying of bridges with UAV-photogrammetry{,} GNSS{,} Laser Scanner and Total station{,} as well as producing tecnical drawing from photogrammetric point clouds.
}
...
\cvlist{ICEpy4D: a multi-purpose Python package for 4D Image-based Continuos monitoring of glaciers' Evolution with deep learning SfM and low-cost stereo-cameras (\href{https://github.com/franioli/icepy4d}{https://github.com/franioli/icepy4d}).}
